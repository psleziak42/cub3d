...
/*   Updated: 2021/12/15 17:13:12 by rimartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float	ft_vertical_line(t_trigo *trigo, float ra)
{
	...
	{
		rx = ((int)(trigo->px_x / trigo->unit_x_size) * trigo->unit_x_size) - 0.0001;
	...
	{
		rx = ((int)(trigo->px_x / trigo->unit_x_size) * trigo->unit_x_size) + trigo->unit_x_size;
		ry = ((trigo->px_x - rx) * tan(ra)) + trigo->px_y;
		xo = trigo->unit_x_size;
		yo = -xo * tan(ra);
	}
