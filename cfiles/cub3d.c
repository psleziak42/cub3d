...
/*   Updated: 2021/12/15 18:17:33 by rimartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_close_window()
{
	if (get_img(0) != NULL)
	{
		mlx_destroy_image(get_win(0)->mlx_p, get_img(0)[BG].img_address);
		mlx_destroy_image(get_win(0)->mlx_p, get_img(0)[WL].img_address);
		free(get_img(0));
		// get_img(0) = NULL;
	}
